...
class _TodoListState extends State<TodoList> {
  @override
  void initState() {
    Provider.of<TodoProvider>(NavService.navKey.currentContext, listen: false).getTodos();
    super.initState();
  }
      ...
      builder: (ctx, snapshot) => snapshot.connectionState ==
          ...
          : Consumer<TodoProvider>(
              builder: (context, todoProvider, child) {
                ...
                return Container(
                    height: 630,
                    child: todoProvider.todoListItems.isEmpty
                        ? Column(
                              ...
                              return Card(
                                ...
                                child: ListTile(
                                  ...
                                  trailing: IconButton(
                                      ...
                                      onPressed: () {
                                        widget.deleteTd(widget.todo[index].id);
                                        _showSnackBar();
                                      }),
                                ),
                              );
